...
object PivotConstants {
  ...
  val CRUISE_VEL = RotationsPerSecond.of(0.0365) // max theoretical 0.3968  // 0.365
  val MAX_ACCEL = RotationsPerSecondPerSecond.of(1.125) // 5.0, heavily limited by robot tipping // 2.125
